                ...
                <div class="col-xx-12 col-sm-5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-inner margin-bottom-no">
                            ...
                            <div class="card-inner margin-bottom-no">
							    <p class="card-heading"><i class="icon icon-md">account_circle</i>群组</p>
									<dl class="dl-horizontal">

                                          {if $user->class!=0}
                                              <p><dt>Telegram(VIP可见)</dt>
											<dd><i class="icon icon-md t4-text">stars</i>&nbsp;<a href="https://example.com/telegram-group" target="view_window">点击加入TG群</a></dd>
                                              <p><dt>管理员(VIP可见)</dt>
											<dd><i class="icon icon-md t4-text">stars</i>&nbsp;<a href="https://example.com/telegram-contact" target="view_window">点击发起TG对话</a></dd>
                                              <p><dt>Telegram通知频道(VIP可见)</dt>
											<dd><i class="icon icon-md t4-text">stars</i>&nbsp;<a href="https://example.com/telegram-channel" target="view_window">点击加入TG通知频道</a></dd>
                                          {else}
										...
										<div class="tab-pane fade active in" id="sub_center">
											...
											<div class="tab-pane fade active in" id="sub_center_general">
												<p><span class="icon icon-lg text-white">filter_1</span> [ SS ]：
													<a id="general_ss" class="copy-config btn-dl" onclick=Copyconfig("/user/getUserAllURL?type=ss","#general_ss","")><i class="material-icons icon-sm">how_to_vote</i>全部 URL</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["ss2022"]}"><i class="material-icons icon-sm">content_copy</i>SS2022 订阅</a>
												</p>
												<hr/>
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_4</span> [ VLESS REALITY ]：
													<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["vless"]}"><i class="material-icons icon-sm">content_copy</i>独立订阅</a>
												</p>
												<hr/>
												<p><span class="icon icon-lg text-white">filter_5</span> [ Clash ]：
													<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["clash"]}"><i class="material-icons icon-sm">content_copy</i>订阅链接</a>.<a class="btn-dl" href="clash://install-config?url={urlencode($subInfo["clash"])}"><i class="material-icons icon-sm">open_in_new</i>一键订阅</a>
												</p>
												<hr/>
												<p><span class="icon icon-lg text-white">filter_6</span> [ Surge v5 ]：
													<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["surge5"]}"><i class="material-icons icon-sm">content_copy</i>订阅链接</a>.<a class="btn-dl" href="surge:///install-config?url={urlencode($subInfo["surge5"])}"><i class="material-icons icon-sm">open_in_new</i>一键订阅</a>
												</p>
												<hr/>
												<p><span class="icon icon-lg text-white">filter_7</span> [ sing-box ]：
													<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["singbox"]}"><i class="material-icons icon-sm">content_copy</i>订阅链接</a>.<a class="btn-dl" href="sing-box://import-remote-profile?url={urlencode($subInfo["singbox"])}#{urlencode($config["appName"])}"><i class="material-icons icon-sm">open_in_new</i>一键订阅</a>
												</p>
												<hr/>
												<p><span class="icon icon-lg text-white">filter_8</span> [ Loon ]：
													<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["loon"]}"><i class="material-icons icon-sm">content_copy</i>订阅链接</a>.<a class="btn-dl" href="loon://import?sub={urlencode($subInfo["loon"])}"><i class="material-icons icon-sm">open_in_new</i>一键订阅</a>
												</p>
											</div>
											...
											<div class="tab-pane fade" id="sub_center_windows">
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_3</span> <a class="btn-dl" href="{if $config["subscribe_client"]===true}{if $config["subscribe_client_url"]==''}/user/getPcClient{else}{$config["subscribe_client_url"]}/getClient/{$getClient}{/if}?type=ssr-win{else}https://github.com/shadowsocksrr/shadowsocksr-csharp/releases{/if}"><i class="material-icons">save_alt</i> 下载</a> SSR(R) - [ SS/SSR ]：</p><p><span class="icon icon-lg text-white">filter_4</span> <a class="btn-dl" href="https://github.com/Fndroid/clash_for_windows_pkg/releases"><i class="material-icons">save_alt</i> 下载</a> Clash for Windows - [ SS/VMess ]：</p>
											...
											{/if}
												<p><span class="icon icon-lg text-white">filter_1</span> <a class="btn-dl" href="https://itunes.apple.com/us/app/surge-3/id1442620678?ls=1&mt=8"><i class="material-icons">save_alt</i> 下载</a> Surge - [ SS/VMess ]：</p>
													...
													<p>使用方式：<a class="btn-dl" href="surge3:///install-config?url={urlencode($subInfo["surge4"])}"><i class="material-icons icon-sm">how_to_vote</i>4.x 一键</a>.<a class="btn-dl" href="surge3:///install-config?url={urlencode($subInfo["surge3"])}"><i class="material-icons icon-sm">how_to_vote</i>3.x 一键</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["surge_node"]}"><i class="material-icons icon-sm">how_to_vote</i>节点 List</a>.<a class="btn-dl" href="surge:///install-config?url={urlencode($subInfo["surge2"])}"><i class="material-icons icon-sm">how_to_vote</i>2.x 一键</a></p>
												<hr/>
												...
												<p><span class="icon icon-lg text-white">filter_4</span> <a class="btn-dl" href="https://apps.apple.com/us/app/quantumult-x/id1443988620"><i class="material-icons">save_alt</i> 下载</a> QuantumultX - [ SS/SSR/VMess ]：</p>
													...
													<p>使用方式：<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["quantumultx"]}"><i class="material-icons icon-sm">how_to_vote</i>混合订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["ssr"]}"><i class="material-icons icon-sm">how_to_vote</i>SSR 订阅</a></p>
												<hr/>
											...
											<div class="tab-pane fade" id="sub_center_android">
												<p><span class="icon icon-lg text-white">filter_1</span> <a class="btn-dl" href="https://github.com/shadowsocks/shadowsocks-android/releases"><i class="material-icons">save_alt</i> 下载</a> SS - [ SS ]：</p>
													...
													<p>使用方式：<a class="copy-text btn-dl" data-clipboard-text="{$subInfo["ssa"]}"><i class="material-icons icon-sm">how_to_vote</i>拷贝链接</a></p>
												<hr/>
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_5</span> <a class="btn-dl" href="https://rink.hockeyapp.net/recruit/2113783c503645abb0a5ec6317e1a169"><i class="material-icons">save_alt</i> 下载</a> Surfboard - [ SS/VMess ]：</p>
